...
const theme = {
  ...
  brandLinearGradient: 'linear-gradient(180deg, #FFDD57 0%, rgba(255, 208, 21, 0.1) 100%)',
  brandDarkLinearGradient: 'linear-gradient(180deg, #FFD015 0%, rgba(255, 208, 21, 0.1) 100%)',
  borders: {
